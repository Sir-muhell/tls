...
//Register
if (isset($_POST['name']) && isset($_POST['email']) && isset($_POST['company']) && isset($_POST['role']) ) {
	$name 		= $_POST['name'];
	$email	= $_POST['email'];
	...
	if(email_exist($email)) {
        ...
        $sqlt = "INSERT INTO register(`name`, `email`, `company`, `role`)";
		$sqlt.= " VALUES('$name', '$email', '$company', '$role')";
		$result = query($sqlt);
		if ($result != 1) {
